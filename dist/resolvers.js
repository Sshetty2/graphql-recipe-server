...
const {
  Message
} = require('../models'); // require('dotenv').config();
...
const resolvers = {
  ...
  Subscription: {
    ...
    messageUpdated: {
      subscribe: withFilter(() => pubsub.asyncIterator('MESSAGE_UPDATED'), (payload, variables) => {
